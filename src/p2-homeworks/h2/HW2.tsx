...
// types
export type AffairPriorityType = "any" | "high" | "middle" | "low"// need to fix any
...
export const filterAffairs = (affairs: Array<AffairType>, filter: FilterType): any => { // need to fix any
    ...
    if (filter === "all") {
        ...
        return affairs.filter((s) => s.priority === "low")
    } else if (filter === "high") {
        return affairs.filter((s) => s.priority === "high")
    } else if (filter === "middle") {
        return affairs.filter((s) => s.priority === "middle")
    }
    // need to fix
}
